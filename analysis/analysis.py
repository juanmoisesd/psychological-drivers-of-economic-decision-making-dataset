# analysis.py — Psychological Drivers of Economic Decision-Making Dataset
...
keywords = ['cognitive biases', 'behavioral economics', 'decision making', 'risk aversion', 'confirmation bias']
...
print(f"Dataset: Psychological Drivers of Economic Decision-Making ")
print(f"DOI: 10.5281/zenodo.18971801")
...
fig.suptitle("Psychological Drivers of Economic Decision-Making Dataset", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Psychological Drivers of Economic Decision-Making Dataset. Zenodo. https://doi.org/10.5281/zenodo.18971801
""")
